...
GCC_PATH="C:/USERS/REWOODPC/SCOOP/APPS/GCC-ARM-NONE-EABI/CURRENT/BIN
ifdef GCC_PATH
...
flash: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/REWOODPC/SCOOP/SHIMS/OPENOCD.EXE" -f ./openocd.cfg -c "program $(BUILD_DIR)/$(TARGET).elf verify reset exit"

#######################################
# erase
#######################################
erase: $(BUILD_DIR)/$(TARGET).elf
	"C:/USERS/REWOODPC/SCOOP/SHIMS/OPENOCD.EXE" -f ./openocd.cfg -c "init; reset halt; stm32f1x mass_erase 0; exit"
